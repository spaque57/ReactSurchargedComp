                ...
                ComponentWithInjectedProps.prototype.render = function () {
                    ...
                    return (React.createElement(CustomizerContext.Consumer, null, function (context) {
                        ...
                        if (concatStyles && (defaultProps.styles || componentProps.styles)) {
                            ...
                            return React.createElement(ComposedComponent, __assign$1({}, defaultProps, componentProps, { styles: mergedStyles }));
                        }
                        return React.createElement(ComposedComponent, __assign$1({}, defaultProps, componentProps));
                    }));
                };
    ...
    var Wrapped = /** @class */ (function (_super) {
        ...
        function Wrapped() {
            ...
            _this._renderContent = function (context) {
                ...
                return React.createElement(Component, __assign$1({}, rest, additionalProps, _this.props, { styles: _this._styles }));
            };
...
var CalloutContentBase = /** @class */ (function (_super) {
    ...
    CalloutContentBase.prototype.render = function () {
        ...
        var content = (React.createElement("div", { ref: this._hostElement, className: this._classNames.container, style: visibilityStyle },
            React.createElement("div", __assign$1({}, getNativeProps(this.props, divProperties, ARIA_ROLE_ATTRIBUTES), { className: css(this._classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]), style: positions ? positions.elementPosition : OFF_SCREEN_STYLE, tabIndex: -1, 
...
var FabricBase = /** @class */ (function (_super) {
    ...
    FabricBase.prototype.render = function () {
        ...
        return React.createElement("div", __assign$1({}, divProps, { className: classNames.root, ref: this._rootElement }));
    };
...
var LayerBase = /** @class */ (function (_super) {
    ...
    LayerBase.prototype.render = function () {
        ...
        return (React.createElement("span", { className: "ms-layer", ref: this._rootRef }, layerElement &&
            ReactDOM.createPortal(React.createElement(Fabric, __assign$1({}, (!eventBubblingEnabled && _getFilteredEvents()), { className: classNames.content }), this.props.children), layerElement)));
    };
...
var Callout = /** @class */ (function (_super) {
    ...
    Callout.prototype.render = function () {
        ...
        var content = React.createElement(CalloutContent, __assign$1({}, rest));
        return this.props.doNotLayer ? content : React.createElement(Layer, __assign$1({}, layerProps), content);
    };
    return Callout;
}(React.Component));
...
var TooltipBase = /** @class */ (function (_super) {
    ...
    TooltipBase.prototype.render = function () {
        ...
        return (React.createElement(Callout, __assign$1({ target: targetElement, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL }, calloutProps, getNativeProps(this.props, divProperties, ['id']), { className: this._classNames.root }),
...
var TooltipHostBase = /** @class */ (function (_super) {
    ...
    TooltipHostBase.prototype.render = function () {
        ...
        return (React.createElement("div", __assign$1({ className: this._classNames.root, ref: this._tooltipHost }, { onFocusCapture: this._onTooltipMouseEnter }, { onBlurCapture: this._hideTooltip }, { onMouseEnter: this._onTooltipMouseEnter, onMouseLeave: this._onTooltipMouseLeave, onKeyDown: this._onTooltipKeyDown, "aria-describedby": ariaDescribedBy }),
            children,
            showTooltip && (React.createElement(Tooltip, __assign$1({ id: tooltipId, delay: delay, content: content, targetElement: this._getTargetElement(), directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, calloutProps: assign$1({}, calloutProps, {
...
var ImageBase = /** @class */ (function (_super) {
    ...
    ImageBase.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames.root, style: { width: width, height: height }, ref: this._frameElement },
            React.createElement("img", __assign$1({}, imageProps, { onLoad: this._onImageLoaded, onError: this._onImageError, key: KEY_PREFIX + this.props.src || '', className: classNames.image, ref: this._imageElement, src: src, alt: alt, role: role }))));
    };
...
var FontIcon = function (props) {
    ...
    return (React.createElement("i", __assign$1({ "data-icon-name": iconName }, containerProps, nativeProps, { className: css(MS_ICON, classNames.root, iconClassName, !iconName && classNames.placeholder, className) }), children));
};
/**
...
var IconBase = /** @class */ (function (_super) {
    ...
    IconBase.prototype.render = function () {
        ...
        return (React.createElement(RootType, __assign$1({ "data-icon-name": iconName }, containerProps, nativeProps, { className: classNames.root }), isImage ? React.createElement(ImageType, __assign$1({}, imageProps)) : children));
    };
    return IconBase;
}(React.Component));
...
var FocusZone = /** @class */ (function (_super) {
    ...
    FocusZone.prototype.render = function () {
        ...
        return (React.createElement(Tag, __assign$1({ role: "presentation", "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy }, divProps, rootProps, { 
...
function withResponsiveMode(ComposedComponent) {
    var resultClass = /** @class */ (function (_super) {
        ...
        WithResponsiveMode.prototype.render = function () {
            ...
            return responsiveMode === ResponsiveMode.unknown ? null : (React.createElement(ComposedComponent, __assign$1({ ref: this._updateComposedComponentRef, responsiveMode: responsiveMode }, this.props)));
        };
...
var renderItemIcon = function (props) {
    ...
    return React.createElement(Icon, __assign$1({}, iconProps, { className: classNames.icon }));
};
...
var renderSubMenuIcon = function (_a) {
    var item = _a.item, classNames = _a.classNames;
    if (hasSubmenu(item)) {
        return React.createElement(Icon, __assign$1({ iconName: getRTL() ? 'ChevronLeft' : 'ChevronRight' }, item.submenuIconProps, { className: classNames.subMenuIcon }));
    }
    return null;
};
...
var ContextualMenuButton = /** @class */ (function (_super) {
    ...
    ContextualMenuButton.prototype.render = function () {
        ...
        return (React.createElement(KeytipData, { keytipProps: keytipProps, ariaDescribedBy: buttonNativeProperties['aria-describedby'], disabled: isItemDisabled(item) }, function (keytipAttributes) { return (React.createElement("button", __assign$1({ ref: _this._btn }, buttonNativeProperties, itemButtonProperties, keytipAttributes),
            React.createElement(ChildrenRenderer, __assign$1({ componentRef: item.componentRef, item: item, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks && onItemClick ? onItemClick : undefined, hasIcons: hasIcons, openSubMenu: openSubMenu, dismissSubMenu: dismissSubMenu, dismissMenu: dismissMenu, getSubmenuTarget: _this._getSubmenuTarget }, itemProps)))); }));
    };
...
var ContextualMenuSplitButton = /** @class */ (function (_super) {
    ...
    ContextualMenuSplitButton.prototype._renderSplitPrimaryButton = function (item, classNames, index, hasCheckmarks, hasIcons) {
        ...
        return (React.createElement("button", __assign$1({}, getNativeProps(itemProps, buttonProperties)),
            React.createElement(ChildrenRenderer, __assign$1({ "data-is-focusable": false, item: itemProps, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks && onItemClick ? onItemClick : undefined, hasIcons: hasIcons }, itemComponentProps))));
    };
    ...
    ContextualMenuSplitButton.prototype._renderSplitIconButton = function (item, classNames, index, keytipAttributes) {
        ...
        var itemComponentProps = item.itemProps;
        return (React.createElement("button", __assign$1({}, buttonProps),
            React.createElement(ChildrenRenderer, __assign$1({ componentRef: item.componentRef, item: itemProps, classNames: classNames, index: index, hasIcons: false, openSubMenu: openSubMenu, dismissSubMenu: dismissSubMenu, dismissMenu: dismissMenu, getSubmenuTarget: this._getSubmenuTarget }, itemComponentProps))));
    };
...
var ContextualMenuBase = /** @class */ (function (_super) {
            ...
            return (React.createElement(Callout, __assign$1({ styles: calloutStyles }, calloutProps, { target: target, isBeakVisible: isBeakVisible, beakWidth: beakWidth, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, gapSpace: gapSpace, coverTarget: coverTarget, doNotLayer: doNotLayer, className: css('ms-ContextualMenu-Callout', calloutProps && calloutProps.className), setInitialFocus: shouldFocusOnMount, onDismiss: this.props.onDismiss, onScroll: this._onScroll, bounds: bounds, directionalHintFixed: directionalHintFixed, alignTargetEdge: alignTargetEdge, hidden: this.props.hidden }),
                React.createElement("div", { "aria-label": ariaLabel, "aria-labelledby": labelElementId, style: contextMenuStyle, ref: function (host) { return (_this._host = host); }, id: id, className: this._classNames.container, tabIndex: shouldFocusOnContainer ? 0 : -1, onKeyDown: this._onMenuKeyDown, onKeyUp: this._onKeyUp, onFocusCapture: this._onMenuFocusCapture },
                    title && React.createElement("div", { className: this._classNames.title },
                        ...
                        title,
                        " "),
                    items && items.length ? (React.createElement(FocusZone, __assign$1({}, this._adjustedFocusZoneProps, { className: this._classNames.root, isCircularNavigation: true, handleTabKey: FocusZoneTabbableElements.all }), onRenderMenuList({
                        items: items,
    ...
    ContextualMenuBase.prototype._renderHeaderMenuItem = function (item, classNames, index, hasCheckmarks, hasIcons) {
        ...
        return (React.createElement("div", __assign$1({ className: this._classNames.header }, divHtmlProperties, { style: item.style }),
            React.createElement(ChildrenRenderer, __assign$1({ item: item, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks ? this._onItemClick : undefined, hasIcons: hasIcons }, itemProps))));
    };
...
var BaseButton = /** @class */ (function (_super) {
    ...
    function BaseButton(props, rootClassName) {
        ...
        _this._onRenderIcon = function (buttonProps, defaultRender) {
            ...
            if (iconProps && (iconProps.iconName !== undefined || iconProps.imageProps)) {
                ...
                return React.createElement(Icon, __assign$1({ className: css(_this._classNames.icon, className) }, rest));
            }
            return null;
        };
        ...
        _this._onRenderMenuIcon = function (props) {
            ...
            return React.createElement(Icon, __assign$1({ iconName: "ChevronDown" }, menuIconProps, { className: _this._classNames.menuIcon }));
        };
    ...
    BaseButton.prototype._onRenderContent = function (tag, buttonProps) {
        ...
        React.createElement(KeytipData, { keytipProps: !this._isSplitButton ? keytipProps : undefined, ariaDescribedBy: buttonProps['aria-describedby'], disabled: disabled }, function (keytipAttributes) { return (React.createElement(Tag, __assign$1({}, buttonProps, keytipAttributes),
    ...
    BaseButton.prototype._onRenderSplitButtonMenuButton = function (classNames, keytipAttributes) {
        ...
        return (React.createElement(BaseButton, __assign$1({}, splitButtonProps, { "data-ktp-execute-target": keytipAttributes['data-ktp-execute-target'], onMouseDown: this._onMouseDown, tabIndex: -1 })));
    };
...
var IconButton = /** @class */ (function (_super) {
    ...
    IconButton.prototype.render = function () {
        ...
        return (React.createElement(BaseButton, __assign$1({}, this.props, { variantClassName: "ms-Button--icon", styles: getStyles$1(theme, styles), onRenderText: nullRender, onRenderDescription: nullRender })));
    };
...
var MessageBarBase = /** @class */ (function (_super) {
    ...
    MessageBarBase.prototype._getIconSpan = function () {
        return (React.createElement("div", { className: this._classNames.iconContainer, "aria-hidden": true },
    ...
    MessageBarBase.prototype._renderInnerText = function () {
        ...
        return (React.createElement("div", { className: this._classNames.text, id: this.state.labelId },
            React.createElement("span", __assign$1({ className: this._classNames.innerText, role: "status", "aria-live": this._getAnnouncementPriority() }, nativeProps),
...
var InfoMark = function (props) {
    ...
    if (props.size != null && props.size != '')
        size = props.size;
    return (React.createElement("span", { style: { cursor: 'help', fontSize: size } },
        React.createElement(TooltipHost, { content: props.label, calloutProps: { gapSpace: 0 } },
...
export { InfoMark, MessageBarComp, NotificationPopup };
